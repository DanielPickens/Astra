...
cat > "./.bintray.json" <<EOF
{
    "package": {
        ...
        "website_url": "https://github\.com/danielpickens/astra",
        "issue_tracker_url": "https://github\.com/danielpickens/astra/issues",
        "vcs_url": "https://github\.com/danielpickens/astra.git",
        "licenses": ["Apache-2.0"],
    ...
    "version": {
        "name": "latest",
        "desc": "astra build from master branch",
        "released": "${DATE}",
