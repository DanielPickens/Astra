...
go mod init github\.com/danielpickens/astra
...
go mod edit -require github.com/daniel-pickens/alizer/go@v0.0.0-20220714080930-59b004fd4586
go mod edit -require github.com/daniel-pickens/service-binding-operator@v1.0.1-0.20211222115357-5b7bbba3bfb3
