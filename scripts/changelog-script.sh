...
MIRROR="https://developers.redhat.com/content-gateway/rest/mirror/pub/openshift-v4/clients/astra/$2/"
INSTALLATION_GUIDE="https://astra.dev/docs/overview/installation"

echo -e "# Installation of $2
To install astra, follow our installation guide at [astra.dev]($INSTALLATION_GUIDE)
