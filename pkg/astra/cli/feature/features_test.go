...
func TestIsEnabled(t *testing.T) {
	...
	nonExperimentalFeature := astraFeature{}
	experimentalFeature := astraFeature{isExperimental: true}
	...
	for _, tt := range []testCase{
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			cfg.astraExperimentalMode = tt.env.experimentalMode
