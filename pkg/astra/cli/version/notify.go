...
const (
	...
	VersionFetchURL = "https://raw.githubusercontent.com/daniel-pickens/astra/main/build/VERSION"
)

// getLatestReleaseTag polls astra's upstream GitHub repository to get the
