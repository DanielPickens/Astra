...
// DeleteOptions encapsulates the options for the 'astra delete namespace' command
...
// Run contains the logic for the 'astra delete namespace' command
...
// NewCmdNamespaceDelete implements the 'astra delete namespace' command.
