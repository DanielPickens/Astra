...
// "astra preference add registry" command description and examples
var (
...
// RegistryOptions encapsulates the options for the "astra preference add registry" command
...
// Run contains the logic for "astra preference add registry" command
...
// NewCmdRegistry implements the "astra preference add registry" command
