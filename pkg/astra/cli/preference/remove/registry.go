...
import (
	...
	registryUtil "github\.com/danielpickens/astra/pkg/registry"
)

const registryCommandName = "registry"

// "astra preference delete registry" command description and examples
var (
...
// RegistryOptions encapsulates the options for the "astra preference remove registry" command
...
// Run contains the logic for "astra preference remove registry" command
...
// NewCmdRegistry implements the "astra preference remove registry" command
