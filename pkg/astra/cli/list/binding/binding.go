...
// BindingListOptions encapsulates the options for the astra list binding command
...
// Run contains the logic for the astra list binding command
...
// NewCmdBindingList implements the astra list binding command.
func NewCmdBindingList(name, fullName string, testClientset clientset.Clientset) *cobra.Command {
	...
	bindingListCmd.Flags().StringVar(&o.namespaceFlag, "namespace", "", "Namespace for astra to scan for bindings")
