...
func TestListServices(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				selector: astralabels.GetSelector("nodejs", "app", astralabels.ComponentDevMode, false),
			},
			returnedServices: corev1.ServiceList{
				Items: astraTestingUtil.FakeKubeServices("nodejs"),
			},
			want: astraTestingUtil.FakeKubeServices("nodejs"),
		},
		{
...
func TestClient_GetOneServiceFromSelector(t *testing.T) {
	wantService := astraTestingUtil.FakeKubeService("nodejs", "nodejs-app")
...

		{
			...
			returnedServices: corev1.ServiceList{
				Items: []corev1.Service{
					astraTestingUtil.FakeKubeService("nodejs", "nodejs-app"),
				},
			},
			want: &wantService,
		},
