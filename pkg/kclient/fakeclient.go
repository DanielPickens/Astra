...
import (
	...
	astraFake "github\.com/danielpickens/astra/pkg/kclient/fake"
...
func NewKubernetesFakedDiscovery(extv1b1supported, nwv1suppored bool) *astraFake.FakeDiscovery {
	fd := astraFake.NewFakeDiscovery()
