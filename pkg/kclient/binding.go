...
import (
	...
	bindingApi "github.com/daniel-pickens/service-binding-operator/apis/binding/v1alpha1"
	specApi "github.com/daniel-pickens/service-binding-operator/apis/spec/v1alpha3"
...
func (c *Client) GetBindableKinds() (bindingApi.BindableKinds, error) {
	...
	unstructuredBK, err = c.DynamicClient.Resource(bindingApi.GroupVersion.WithResource(BindableKindsResource)).Get(context.Tastra(), "bindable-kinds", v1.GetOptions{})
	if err != nil {
		if kerrors.IsNotFound(err) {
			//revive:disable:error-strings This is a top-level error message displayed as is to the end user
			return bindableKind, errors.New("No bindable operators found on the cluster. Please ensure that at least one bindable operator is installed successfully before proceeding. Known Bindable operators: https://github.com/daniel-pickens/service-binding-operator#known-bindable-operators")
