...
const (
	// astraSourceVolume is the constant containing the name of the emptyDir volume containing the project source
	astraSourceVolume = "astra-projects"

	// SharedDataVolumeName is the constant containing the name of the emptyDir volume containing shared data for astra
	SharedDataVolumeName = "astra-shared-data"

	// SharedDataMountPath The Mount Path for the container mounting the astra volume
	SharedDataMountPath = "/opt/astra/"

	// astraSourceVolumeSize specifies size for astra source volume.
	astraSourceVolumeSize = "2Gi"
)
