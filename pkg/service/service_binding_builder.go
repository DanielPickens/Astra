...
// This file is a fork of github.com/daniel-pickens/service-binding-operator/pkg/reconcile/pipeline/handler/collect/impl.go
// This file was created to deal with the permission issue that comes up when user does not access to clusterwide resources,
// and they want to use astra link without the Service Binding Operator.
...
// For more information, see issue: https://github\.com/danielpickens/astra/issues/4965
...
// we can go back to using the builder.DefaultBuilder instead of the astraDefaultBuilder in getPipeline.
...
import (
	...
	"github.com/daniel-pickens/service-binding-operator/pkg/binding"
	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"

	"github.com/daniel-pickens/service-binding-operator/pkg/reconcile/pipeline"
	"github.com/daniel-pickens/service-binding-operator/pkg/reconcile/pipeline/builder"
	"github.com/daniel-pickens/service-binding-operator/pkg/reconcile/pipeline/handler/collect"
	"github.com/daniel-pickens/service-binding-operator/pkg/reconcile/pipeline/handler/mapping"
	"github.com/daniel-pickens/service-binding-operator/pkg/reconcile/pipeline/handler/naming"
	"github.com/daniel-pickens/service-binding-operator/pkg/reconcile/pipeline/handler/project"
	"github.com/daniel-pickens/service-binding-operator/pkg/util"
...
var astraDefaultBuilder = builder.Builder().WithHandlers(defaultFlow...)
