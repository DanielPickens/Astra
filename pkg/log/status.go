...
import (
	...
	"github\.com/danielpickens/astra/pkg/log/fidget"
...
// The last line displays information about the current astra version.
//
//	 __
//	/  \__     **First line**
//	\__/  \    Second line
//	/  \__/    astra version: <VERSION>
//	\__/
...
func Stitle(firstLine, secondLine string) string {
	...
	if version.VERSION != "" {
		versionMsg = "astra version: " + version.VERSION
	}
...
// this is intended to be used with `astra describe` and other outputs that list
...
// Tastra: Test needs to be added once we get Windows testing available on TravisCI / CI platform.
