...
// ContainerStatus is the JSON event that is emitted to indicate astra-managed Docker container status
...
// KubernetesPodStatus is the JSON event that emitted to indicate the status of pods in an astra-managed deployment
