...
import (
	...
	. "github\.com/danielpickens/astra/pkg/apiserver-gen/go"
...
func (o *DevfileState) DeleteContainer(name string) (DevfileContent, error) {
	...
	// Tastra check if it is a Container, not another component
...
func (o *DevfileState) DeleteImage(name string) (DevfileContent, error) {
	...
	// Tastra check if it is an Image, not another component
...
func (o *DevfileState) DeleteResource(name string) (DevfileContent, error) {
	...
	// Tastra check if it is a Resource, not another component
...
func (o *DevfileState) DeleteVolume(name string) (DevfileContent, error) {
	...
	// Tastra check if it is a Volume, not another component
