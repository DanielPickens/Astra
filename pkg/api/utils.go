...
func GetDevfileData(devfileObj parser.DevfileObj) (*DevfileData, error) {
	...
	return &DevfileData{
		...
		Commands:             commands,
		SupportedastraFeatures: getSupportedastraFeatures(devfileObj.Data),
	}, nil
}

func getSupportedastraFeatures(devfileData data.DevfileData) *SupportedastraFeatures {
	return &SupportedastraFeatures{
