...
// ResourcesList is the result of the `astra list` command
type ResourcesList struct {
	// ComponentInDevfile is the component name present in the local Devfile when `astra list` is executed, or empty
