...
// copyFiles is list of changed files captured during `astra watch` as well as binary file path
...
// During `astra watch`, localPath represent base directory path whereas copyFiles contains list of changed Files
