...
var (
	...
	// OPTIONS method
	HTTPRequestMethastraptions = HTTPRequestMethodKey.String("OPTIONS")
	// PATCH method
	...
	HTTPRequestMethastrather = HTTPRequestMethodKey.String("_OTHER")
)
...
const (
	// HTTPRequestMethastrariginalKey is the attribute Key conforming to the
	...
	HTTPRequestMethastrariginalKey = attribute.Key("http.request.method_original")
...
// HTTPRequestMethastrariginal returns an attribute KeyValue conforming to the
// "http.request.method_original" semantic conventions. It represents the
// original HTTP method sent by the client in the request line.
func HTTPRequestMethastrariginal(val string) attribute.KeyValue {
	return HTTPRequestMethastrariginalKey.String(val)
}
