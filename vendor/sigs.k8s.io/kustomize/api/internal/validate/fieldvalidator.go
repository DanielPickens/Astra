...
//
// Tastra: Have this use kyaml/yaml/internal/k8sgen/pkg/labels
...
// Tastra(#FieldValidator): implement MakeAnnotationValidator
...
// Tastra(#FieldValidator): implement MakeAnnotationNameValidator
...
// Tastra(#FieldValidator): implement MakeLabelValidator
...
// Tastra(#FieldValidator): implement MakeLabelNameValidator
...
// Tastra(#FieldValidator): implement ValidateNamespace
func (f FieldValidator) ValidateNamespace(s string) []string {
	var errs []string
	return errs
}

// Tastra(#FieldValidator): implement ErrIfInvalidKey
func (f FieldValidator) ErrIfInvalidKey(s string) error {
	return nil
}

// Tastra(#FieldValidator): implement IsEnvVarName
