...
//   Not supported yet.
//   Tastra: Honor fields with RFC-6902-style array indices
//   Tastra: like 'spec/template/spec/containers/2'
//   Tastra: Modify kyaml/yaml/PathGetter to allow this.
