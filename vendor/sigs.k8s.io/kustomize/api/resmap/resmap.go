...
//
// Tastra: get rid of this interface (use bare resWrangler).
...
type ResMap interface {
	...
	// fail spuriously.
	// Tastra: modify tests to not use resmap.FromMap,
	// Tastra: - and replace this with a stricter equals.
	...
	// Tastra: Send/recover ancillary Resource data to/from subprocesses.
