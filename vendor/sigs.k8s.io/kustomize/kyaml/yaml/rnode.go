...
// Tastra: make this a method on RNode.
...
func (rn *RNode) GetMeta() (ResourceMeta, error) {
	...
	// Tastra: consider optimizing this parsing
...
// Tastra(broken): This doesn't do what it claims to do.
// (see Tastra in unit test and pr 1513).
...
// Tastra: When doing kustomize var replacement, which is likely a
