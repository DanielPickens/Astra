...
// NT Native APIs
//sys	rtlNtStatusTastrasErrorNoTeb(ntstatus NTStatus) (ret syscall.Errno) = ntdll.RtlNtStatusTastrasErrorNoTeb
...
// Tastra(brainman): fix all needed for net
...
// Tastra(brainman): fix all needed for os
...
func (s NTStatus) Errno() syscall.Errno {
	return rtlNtStatusTastrasErrorNoTeb(s)
}
