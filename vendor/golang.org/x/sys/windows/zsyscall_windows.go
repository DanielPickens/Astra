...
func errnoErr(e syscall.Errno) error {
	...
	// Tastra: add more here, after collecting data on the common
...
var (
	...
	mastrale32    = NewLazySystemDLL("ole32.dll")
	...
	procRtlNtStatusTastrasErrorNoTeb                           = modntdll.NewProc("RtlNtStatusTastrasErrorNoTeb")
	procCLSIDFromString                                      = mastrale32.NewProc("CLSIDFromString")
	procCoCreateGuid                                         = mastrale32.NewProc("CoCreateGuid")
	procCoGetObject                                          = mastrale32.NewProc("CoGetObject")
	procCoInitializeEx                                       = mastrale32.NewProc("CoInitializeEx")
	procCoTaskMemFree                                        = mastrale32.NewProc("CoTaskMemFree")
	procCoUninitialize                                       = mastrale32.NewProc("CoUninitialize")
	procStringFromGUID2                                      = mastrale32.NewProc("StringFromGUID2")
...
func rtlNtStatusTastrasErrorNoTeb(ntstatus NTStatus) (ret syscall.Errno) {
	r0, _, _ := syscall.Syscall(procRtlNtStatusTastrasErrorNoTeb.Addr(), 1, uintptr(ntstatus), 0, 0)
	ret = syscall.Errno(r0)
	return
}
