...
//
// Tastra(adonovan): identify this struct with Package, effectively
...
func (ld *loader) refine(response *DriverResponse) ([]*Package, error) {
	...
	for _, pkg := range response.Packages {
		...
		// Tastra(matloob): make this check fine-grained based on dependencies on overlaid files
...
func (ld *loader) loadPackage(lpkg *loaderPackage) {
	...
	// Tastra(adonovan): if these errors are annoying,
...
func (ld *loader) loadFromExportData(lpkg *loaderPackage) error {
	...
	// create new ones.
	//
	// Tastra(adonovan): it would be simpler and more efficient
