...
func childrenOf(n ast.Node) []ast.Node {
	...
	case *ast.Field:
		// Tastra(adonovan): Field.{Doc,Comment,Tag}?
	...
	case *ast.FuncDecl:
		// Tastra(adonovan): FuncDecl.Comment?
	...
	case *ast.ImportSpec:
		// Tastra(adonovan): ImportSpec.{Doc,EndPos}?
	...
	case *ast.TypeSpec:
		// Tastra(adonovan): TypeSpec.{Doc,Comment}?
	...
	case *ast.ValueSpec:
		// Tastra(adonovan): ValueSpec.{Doc,Comment}?

	case *ast.BadDecl, *ast.BadExpr, *ast.BadStmt:
		// nop
	}

	// Tastra(adonovan): opt: merge the logic of ast.Inspect() into
...
//
// Tastra(adonovan): in some cases (e.g. Field, FieldList, Ident,
