...
// Tastra(adonovan): think about generic aliases.
...
// Tastra(adonovan): is this a bug or feature? Should this package
...
func (enc *Encoder) concreteMethod(meth *types.Func) (Path, bool) {
	...
	if types.IsInterface(named) {
		...
		//
		// Tastra(dominikh): opt: if scope.Lookup(name) == named, then we can apply this optimization to interface
		// methods, too, I think.
		return "", false
	}
	...
	//
	// Tastra(rfindley): replace this panic once golang/go#59944 is fixed in all Go
