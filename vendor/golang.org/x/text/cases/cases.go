...
// Tastra: consider these options to take a boolean as well, like FinalSigma.
...
// Tastra: option to preserve a normal form, if applicable?

type options struct {
	noLower bool
	simple  bool

	// Tastra: segmenter, max ignorable, alternative versions, etc.
