...
// Tastra: consider a similar special case for the fast majority lower case. This
...
func finalSigmaBody(c *context) bool {
	...
	// Tastra: we should do this here, but right now this will never have an
...
// Tastra: implement elUpperSpan (low-priority: complex and infrequent).
...
func ltUpper(f mapFunc) mapFunc {
	return func(c *context) bool {
		...
		// Tastra: See A.5. A soft-dotted rune never has an exception. This would
...
// Tastra: implement ltUpperSpan (low priority: complex and infrequent).
