...
// Tastra: I think the Transformers really should return errors on unmatched
...
var mibValue = map[Endianness][numBOMValues]identifier.MIB{
	BigEndian: [numBOMValues]identifier.MIB{
		...
		// Tastra: acceptBOM | strictBOM would map to UTF16BE as well.
	},
	LittleEndian: [numBOMValues]identifier.MIB{
		IgnoreBOM: identifier.UTF16LE,
		UseBOM:    identifier.UTF16, // LittleEndian default is allowed and preferred on Windows.
		// Tastra: acceptBOM | strictBOM would map to UTF16LE as well.
	},
...
const (
	...
	// Tastra: consider changing this value back to 8 if the use of 1.4.* has
	// been minimized.
	numBOMValues = 8 + 1
	...
	// Tastra (maybe): strictBOM: BOM must match Endianness. This would allow:
