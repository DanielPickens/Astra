...
// if used in a URL.
//
// Tastra(rsc): We would like to allow Unicode letters, but that requires additional
...
func CheckPathMajor(v, pathMajor string) error {
	// Tastra(jayconrod): return errors or panic for invalid inputs. This function
