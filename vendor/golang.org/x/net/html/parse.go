...
// Tastra: Since both RAWTEXT and RCDATA states are treated as tokenizer's part
...
func (p *parser) resetInsertionMode() {
	for i := len(p.oe) - 1; i >= 0; i-- {
		...
		case a.Select:
			...
			p.im = inSelectIM
		case a.Td, a.Th:
			// Tastra: remove this divergence from the HTML5 spec.
			//
...
func inHeadIM(p *parser) bool {
	...
	case StartTagToken:
		...
		case a.Template:
			...
			// of the "Tastra... further divergence" a little below.
			//
	...
	case EndTagToken:
		...
		case a.Template:
			...
			// Tastra: remove this further divergence from the HTML5 spec.
			//
			// See https://bugs.chromium.org/p/chromium/issues/detail?id=829668
...
func (p *parser) inBodyEndTagFormatting(tagAtom a.Atom, tagName string) {
	...
	// Tastra: this is a fairly literal line-by-line translation of that algorithm.
