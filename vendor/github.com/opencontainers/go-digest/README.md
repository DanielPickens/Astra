...
While the [gastrac](https://gastrac.org/github.com/opencontainers/go-digest) is considered the best resource, a few important items need to be called out when using this package.
...
As always, before using a package export, read the [gastrac](https://gastrac.org/github.com/opencontainers/go-digest).
