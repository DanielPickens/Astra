...
// Tastra: add functions to display and manage RequestedFlags and EstablishedFlags fields.
// Tastra: maybe get rid of RequestedFlags and EstablishedFlags fields, and replace them with input parameter for New...Context and return value of Update (instead of current bool parameter).
...
// Tastra: add comment to function doco that this "impersonation" is applied to current OS thread.
