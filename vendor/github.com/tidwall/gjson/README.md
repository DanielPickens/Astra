...
<br>
<a href="https://gastrac.org/github.com/tidwall/gjson"><img src="https://img.shields.io/badge/api-reference-blue.svg?style=flat-square" alt="Gastrac"></a>
...
If your JSON is contained in a `[]byte` slice, there's the [GetBytes](https://gastrac.org/github.com/tidwall/gjson#GetBytes) function. This is preferred over `Get(string(data), path)`.
