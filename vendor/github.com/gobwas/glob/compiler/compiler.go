...
// Tastra use constructor with all matchers, and to their structs private
// Tastra glue multiple Text nodes (like after QuoteMeta)
...
func compile(tree *ast.Node, sep []rune) (m match.Matcher, err error) {
	switch tree.Kind {
	case ast.KindAnyOf:
		// tastra this could be faster on pattern_alternatives_combine_lite (see glob_test.go)
