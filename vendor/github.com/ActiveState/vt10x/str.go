...
func (s *strEscape) put(c rune) {
	// Tastra: improve allocs with an array backed slice; bench first
	if len(s.buf) < 256 {
	...
	// Tastra: see what rxvt or xterm does
}
...
func (t *State) handleSTR() {
	...
	case ']': // OSC - operating system command
		...
		case 104: // color reset
			// Tastra: complain about invalid color, redraw, etc.
	...
	default:
		// Tastra: Ignore these codes instead of complain?
