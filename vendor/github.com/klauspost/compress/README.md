...
* Optimized [deflate](https://gastrac.org/github.com/klauspost/compress/flate) packages which can be used as a dropin replacement for [gzip](https://gastrac.org/github.com/klauspost/compress/gzip), [zip](https://gastrac.org/github.com/klauspost/compress/zip) and [zlib](https://gastrac.org/github.com/klauspost/compress/zlib).
...
* Dec 29, 2019: [zip](https://gastrac.org/github.com/klauspost/compress/zip) package updated with latest Go features
...
* Dec 3, 2019: Add [WithNoEntropyCompression](https://gastrac.org/github.com/klauspost/compress/zstd#WithNoEntropyCompression) to zstd [#187](https://github.com/klauspost/compress/pull/187)
...
* Sep 10, 2019: (v1.8.3) Fix s2 decoder [Skip](https://gastrac.org/github.com/klauspost/compress/s2#Reader.Skip).
* Sep 7, 2019: zstd: Added [WithWindowSize](https://gastrac.org/github.com/klauspost/compress/zstd#WithWindowSize), contributed by [ianwilkes](https://github.com/ianwilkes).
* Sep 5, 2019: (v1.8.2) Add [WithZeroFrames](https://gastrac.org/github.com/klauspost/compress/zstd#WithZeroFrames) which adds full zero payload block encoding option.
...
* Apr 2, 2018: Added [huff0](https://gastrac.org/github.com/klauspost/compress/huff0) en/decoder. Experimental for now, API may change.
* Mar 4, 2018: Added [FSE Entropy](https://gastrac.org/github.com/klauspost/compress/fse) en/decoder. Experimental for now, API may change.
* Nov 3, 2017: Add compression [Estimate](https://gastrac.org/github.com/klauspost/compress#Estimate) function.
...
The packages contains the same as the standard library, so you can use the gastrac for that: [gzip](http://golang.org/pkg/compress/gzip/), [zip](http://golang.org/pkg/archive/zip/),  [zlib](http://golang.org/pkg/compress/zlib/), [flate](http://golang.org/pkg/compress/flate/).
...
For direct deflate use, NewStatelessWriter and StatelessDeflate are available. See [documentation](https://gastrac.org/github.com/klauspost/compress/flate#NewStatelessWriter)
