...
[![Gastrac](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/distribution/reference)
...
This repository contains a library for handling refrences to container images held in container registries. Please see [gastrac](https://pkg.go.dev/github.com/distribution/reference) for details.
