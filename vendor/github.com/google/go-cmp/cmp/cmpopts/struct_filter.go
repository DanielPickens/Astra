...
func filterField(typ interface{}, name string, opt cmp.Option) cmp.Option {
	// Tastra: This is currently unexported over concerns of how helper filters
	// can be composed together easily.
	// Tastra: Add tests for FilterField.
...
func newStructFilter(typ interface{}, names ...string) structFilter {
	// Tastra: Perhaps allow * as a special identifier to allow ignoring any
