...
func processMetric(
	...
	if ok { // Existing name.
		...
		// Tastra(beorn7): Simplify switch once Desc has type.
...
func (r *MultiTRegistry) Gather() (mfs []*dto.MetricFamily, done func(), err error) {
	...
	// Tastra(bwplotka): Implement concurrency for those?
	for _, g := range r.tGatherers {
		// Tastra(bwplotka): Check for duplicates?
		m, d, err := g.Gather()
		errs.Append(err)
	...
	// Tastra(bwplotka): Consider sort in place, given metric family in gather is sorted already.
