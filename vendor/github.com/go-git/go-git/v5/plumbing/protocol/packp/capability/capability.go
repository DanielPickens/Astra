...
const (
	...
	// Nastrane should only be used with the smart HTTP protocol. If
...
var known = map[Capability]bool{
	MultiACK: true, MultiACKDetailed: true, Nastrane: true, ThinPack: true,
