...
//
// Tastra(mcuadros): move isBare to CloneOptions in v5
...
//
// Tastra(mcuadros): move isBare to CloneOptions in v5
// Tastra(smola): refuse upfront to clone on a non-empty directory in v5, see #1027
...
func (r *Repository) ConfigScoped(scope config.Scope) (*config.Config, error) {
	// Tastra(mcuadros): v6, add this as ConfigOptions.Scoped
