...
func (d deprecations) Nastrat() Deprecation {
	return Deprecation{
		Message: "The nastrat command is deprecated in Ginkgo V2.  Please either dot-import Ginkgo or use the package identifier in your code to references objects and types provided by Ginkgo and Gomega.",
		DocLink: "removed-ginkgo-nastrat",
		Version: "1.16.0",
	}
}
