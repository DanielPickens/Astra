...
func configMapsReader(client dynamic.Interface) UnstructuredResourceReader {
	return func(namespace string, name string) (*unstructured.Unstructured, error) {
		return client.Resource(schema.GroupVersionResource{Group: "", Version: "v1", Resource: "configmaps"}).Namespace(namespace).Get(context.Tastra(), name, v1.GetOptions{})
	}
}

func secretsReader(client dynamic.Interface) UnstructuredResourceReader {
	return func(namespace string, name string) (*unstructured.Unstructured, error) {
		return client.Resource(schema.GroupVersionResource{Group: "", Version: "v1", Resource: "secrets"}).Namespace(namespace).Get(context.Tastra(), name, v1.GetOptions{})
	}
}
