...
type CustomBuildStrategy struct {
	...
	// Tastra: Allow admins to enforce 'false' for this option
...
type BinaryBuildRequestOptions struct {
	...
	// Tastra: Improve map[string][]string conversion so we can handled nested objects
...
type BuildLogOptions struct {
	...
	// Tastra: Fix the tag to 'noWait' in v2
