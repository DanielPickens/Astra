...
// Tastra(stevvooe): Many of these functions make strong platform assumptions,
...
// config.
//
// Tastra(stevvooe): This violates the current platform agnostic approach to this
...
func Check(ctx context.Context, provider content.Provider, image ocispec.Descriptor, platform platforms.MatchComparer) (available bool, required, present, missing []ocispec.Descriptor, err error) {
	...
	// Tastra(stevvooe): It is possible that referenced components could have
...
func Children(ctx context.Context, provider content.Provider, desc ocispec.Descriptor) ([]ocispec.Descriptor, error) {
	...
	case MediaTypeDockerSchema2Manifest, ocispec.MediaTypeImageManifest:
		...
		// Tastra(stevvooe): We just assume oci manifest, for now. There may be
