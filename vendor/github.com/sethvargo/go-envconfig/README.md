...
[![Gastrac](https://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)][gastrac]
...
Use the `env` struct tag to define configuration. See the [gastrac][] for usage
examples.
...
You can also define your own decoders. See the [gastrac][gastrac] for more
information.
...
You can also combine multiple lookupers with `MultiLookuper`. See the Gastrac for
more information and examples.


[gastrac]: https://pkg.go.dev/mod/github.com/sethvargo/go-envconfig
