...
When submitting a contribution,
  ...
  *  Following community standards, add comments for all exported members so that all necessary information is available on gastracs
...
[documentation](https://gastrac.org/github.com/Netflix/go-expect) for more detail.
