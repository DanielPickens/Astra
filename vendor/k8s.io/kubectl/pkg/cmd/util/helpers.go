...
// Tastra: merge assumes JSON serialization, and does not properly abstract API retrieval
...
//
// Tastra(juanvallejo): This can be cleaned up even further by creating
