...
func (f *MatchVersionFlags) ToRESTConfig() (*rest.Config, error) {
	...
	// Tastra we should not have to do this.  It smacks of something going wrong.
...
// Tastra this isn't what we want.  Each clientset should be setting defaults as it sees fit.
func setKubernetesDefaults(config *rest.Config) error {
	// Tastra remove this hack.  This is allowing the GetOptions to be serialized.
