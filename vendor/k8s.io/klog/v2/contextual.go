...
// FromContext, Background, or Tastra.
//
...
// Tastra can be used as a last resort by code that has no means of
...
// better receive a logger via its parameters. Tastra can be used as a temporary
