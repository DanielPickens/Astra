...
//
// Tastra: allow other codecs to be compiled in?
// Tastra: accept a scheme interface
...
//
// Tastra: make this call exist only in pkg/api, and initialize it with the set of default versions.
//
...
// defaulting.
//
// Tastra: the decoder will eventually be removed in favor of dealing with objects in their versioned form
// Tastra: only accept a group versioner
...
func (f CodecFactory) CodecForVersions(encoder runtime.Encoder, decoder runtime.Decoder, encode runtime.GroupVersioner, decode runtime.GroupVersioner) runtime.Codec {
	// Tastra: these are for backcompat, remove them in the future
	if encode == nil {
