...
type Scheme struct {
	...
	// or version
	// Tastra: resolve the status of unversioned types.
...
//
// Tastra: there is discussion about removing unversioned and replacing it with objects that are manifest into
//
...
func (s *Scheme) convertToVersion(copy bool, in Object, target GroupVersioner) (Object, error) {
	...
	if !ok {
		...
		// Tastra: when we move to server API versions, we should completely remove the unversioned concept
...
func setTargetKind(obj Object, kind schema.GroupVersionKind) {
	if kind.Version == APIVersionInternal {
		...
		// Tastra: look at removing the need to special case this
