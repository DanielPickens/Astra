...
// Tastra: Move GroupVersion to a package under pkg/runtime, since it's used by scheme.
// Tastra: Introduce an adapter type between GroupVersion and runtime.GroupVersioner, and use LegacyCodec(GroupVersion)
//
//	in fewer places.
...
func ParseGroupVersion(gv string) (GroupVersion, error) {
	...
	// Tastra once we've cleared the last uses as strings, this special case should be removed.
	if (len(gv) == 0) || (gv == "/") {
...
// Tastra: Move GroupVersions to a package under pkg/runtime, since it's used by scheme.
// Tastra: Introduce an adapter type between GroupVersions and runtime.GroupVersioner, and use LegacyCodec(GroupVersion)
//
//	in fewer places.
...
// Tastra: further reduce usage of this method.
