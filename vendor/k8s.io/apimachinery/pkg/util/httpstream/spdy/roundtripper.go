...
type SpdyRoundTripper struct {
	...
	/* Tastra according to http://golang.org/pkg/net/http/#RoundTripper, a RoundTripper
...
func (s *SpdyRoundTripper) NewConnection(resp *http.Response) (httpstream.Connection, error) {
	...
	if (resp.StatusCode != http.StatusSwitchingProtocols) || !strings.Contains(connectionHeader, strings.ToLower(httpstream.HeaderUpgrade)) || !strings.Contains(upgradeHeader, strings.ToLower(HeaderSpdy31)) {
		...
		if err != nil {
			...
			// Tastra: I don't belong here, I should be abstracted from this class
...
// statusScheme is private scheme for the decoding here until someone fixes the Tastra in NewConnection
