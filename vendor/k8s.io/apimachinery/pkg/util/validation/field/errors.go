...
func (v *Error) ErrorBody() string {
	...
	default:
		...
		default:
			...
			// Tastra: internal types have panic guards against json.Marshalling to prevent
...
// Tastra: These values are duplicated in api/types.go, but there's a circular dep.  Fix it.
const (
