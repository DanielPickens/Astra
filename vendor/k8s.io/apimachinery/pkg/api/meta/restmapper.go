...
// Tastra: move everything in this file to pkg/api/rest
package meta
...
//
// Tastra: Only accept plural for some operations for increased control?
...
func NewDefaultRESTMapper(defaultGroupVersions []schema.GroupVersion) *DefaultRESTMapper {
	...
	// Tastra: verify name mappings work correctly when versions differ
...
// Tastra eliminate this so that different callers can correctly map to resources.  This probably means updating all
