...
var (
	...
	// Tastra: remove and replace with an interface check
	isListCache = struct {
		lock   sync.RWMutex
...
// Tastra: Replace the code in this check with an interface comparison by
//
...
// Tastra: this will be replaced with an interface in the future
...
func EachListItem(obj runtime.Object, fn func(runtime.Object) error) error {
	...
	// Tastra: Change to an interface call?
	...
	for i := range list {
		...
		case runtime.RawExtension:
			...
			case item.Object != nil:
				list[i] = item.Object
			case item.Raw != nil:
				// Tastra: Set ContentEncoding and ContentType correctly.
