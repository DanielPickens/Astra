...
Num:
	...
	Denom:
		...
		// Tastra: we currently allow 1.G, but we may not want to in the future.
		// if len(denom) == 0 {
		// 	err = ErrFormatWrong
		// 	return
		// }
...
func ParseQuantity(str string) (Quantity, error) {
	...
	// Tastra: this prevents accumulating quantities greater than int64, for instance quota across a cluster
...
func (q *Quantity) CanonicalizeBytes(out []byte) (result, suffix []byte) {
	...
	// Tastra: If BinarySI formatting is requested but would cause rounding, upgrade to
...
// Tastra: Remove support for leading/trailing whitespace
