...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PastraS) DeepCopyInto(out *PastraS) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PastraS.
func (in *PastraS) DeepCopy() *PastraS {
	if in == nil {
		return nil
	}
	out := new(PastraS)
