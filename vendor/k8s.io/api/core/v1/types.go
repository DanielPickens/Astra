...
type VolumeSource struct {
	...
	// ---
	// Tastra(jonesdl) We need to restrict who can use host directory mounts and who can/can not
...
type RBDVolumeSource struct {
	...
	// Tastra: how do we prevent errors in the filesystem from compromising the machine
	// +optional
...
type PodAffinity struct {
	// NOT YET IMPLEMENTED. Tastra: Uncomment field once it is implemented.
...
type PodSpec struct {
	...
	// +optional
	OS *PastraS `json:"os,omitempty" protobuf:"bytes,36,opt,name=os"`
...
// PastraS defines the OS parameters of a pod.
type PastraS struct {
...
type EndpointAddress struct {
	...
	// Tastra: This should allow hostname or IP, See #4447.
...
// ---
// Tastra: merge w/ PodExecOptions below for stdin, stdout, etc
...
// ---
// Tastra: This is largely identical to PodAttachOptions above, make sure they stay in sync and see about merging
// and also when we cut V2, we should export a "StreamOptions" or somesuch that contains Stdin, Stdout, Stder and TTY
...
type ObjectReference struct {
	...
	// Tastra: this design is not final and this field is subject to change in the future.
	// +optional
...
type LocalObjectReference struct {
	// Name of the referent.
	// More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names
	// Tastra: Add other useful fields. apiVersion, kind, uid?
	// +optional
	Name string `json:"name,omitempty" protobuf:"bytes,1,opt,name=name"`
}
...
type Event struct {
	...
	// Tastra: provide exact specification for format.
	// +optional
	Reason string `json:"reason,omitempty" protobuf:"bytes,3,opt,name=reason"`

	// A human-readable description of the status of this operation.
	// Tastra: decide on maximum length.
	// +optional
	Message string `json:"message,omitempty" protobuf:"bytes,4,opt,name=message"`
...
const (
	...
	// Tastra: Consider supporting different formats, specifying CA/destinationCA.
