...
type DeploymentStrategy struct {
	...
	// RollingUpdate.
	//---
	// Tastra: Update this to follow our convention for oneOf, whatever we decide it
	// to be.
	// +optional
...
// Tastra: Add valid condition types of a DaemonSet.
...
type IngressSpec struct {
	...
	// Tastra: Add the ability to specify load-balancer IP through claims
}
...
type IngressTLS struct {
	...
	// Tastra: Consider specifying different modes of termination, protocols etc.
}
...
type HTTPIngressRuleValue struct {
	...
	// Tastra: Consider adding fields for ingress-type specific global
