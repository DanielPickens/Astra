...
// Tastra: Instead of implementing the v1 Marshaler/Unmarshaler,
...
func reorderObjects(d *Decoder, scratch *[]byte) {
	...
	case '{':
		...
		// Tastra(https://go.dev/issue/47619): Use slices.Sort.
		sort.Sort(members)
...
func lessUTF16[Bytes []byte | string](x, y Bytes) bool {
	...
	for {
		...
		// Tastra(https://go.dev/issue/56948): Use a generic implementation
