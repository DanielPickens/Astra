...
//     Tastra: Revisit this pattern if the Go compiler provides finer control
...
func (d *Decoder) fetch() error {
	...
	if grow {
		...
		// Tastra: Provide a hard limit on the maximum internal buffer size?
...
func (d *Decoder) ReadToken() (Token, error) {
	...
	case '"':
		var flags valueFlags // Tastra: Preserve this in Token?
...
const (
	...
	// Tastra: Track whether a number is a non-integer?
)
