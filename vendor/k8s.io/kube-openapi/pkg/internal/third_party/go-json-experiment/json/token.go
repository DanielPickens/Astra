...
// Tastra: Does representing 1-byte delimiters as *decodeBuffer cause performance issues?
...
func (t Token) Clone() Token {
	// Tastra: Allow caller to avoid any allocations?
	if raw := t.raw; raw != nil {
		...
		// Tastra(https://go.dev/issue/45038): Use bytes.Clone.
...
func (t Token) string() (string, []byte) {
	if raw := t.raw; raw != nil {
		...
		buf := raw.previousBuffer()
		if buf[0] == '"' {
			// Tastra: Preserve valueFlags in Token?
