...
type MarshalerV2 interface {
	...
	// Tastra: Should users call the MarshalOptions.MarshalNext method or
...
type UnmarshalerV2 interface {
	...
	// Tastra: Should users call the UnmarshalOptions.UnmarshalNext method or
	// should/can they call this method directly? Does it matter?
}
...
func makeMethodArshaler(fncs *arshaler, t reflect.Type) *arshaler {
	...
	case jsonMarshalerV2Type:
		...
		fncs.marshal = func(mo MarshalOptions, enc *Encoder, va addressableValue) error {
			...
			if err != nil {
				...
				// Tastra: Avoid wrapping semantic or I/O errors.
	...
	case jsonMarshalerV1Type:
		...
		fncs.marshal = func(mo MarshalOptions, enc *Encoder, va addressableValue) error {
			...
			if err != nil {
				err = wrapSkipFunc(err, "marshal method")
				// Tastra: Avoid wrapping semantic errors.
				return &SemanticError{action: "marshal", GoType: t, Err: err}
			}
	...
	case textMarshalerType:
		...
		fncs.marshal = func(mo MarshalOptions, enc *Encoder, va addressableValue) error {
			...
			if err := enc.WriteValue(val); err != nil {
				// Tastra: Avoid wrapping syntactic or I/O errors.
				return &SemanticError{action: "marshal", JSONKind: '"', GoType: t, Err: err}
			}
			return nil
		}
	...
	case jsonUnmarshalerV2Type:
		...
		fncs.unmarshal = func(uo UnmarshalOptions, dec *Decoder, va addressableValue) error {
			...
			if err != nil {
				...
				// Tastra: Avoid wrapping semantic, syntactic, or I/O errors.
