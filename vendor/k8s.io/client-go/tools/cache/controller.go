...
type Config struct {
	...
	// Tastra: add interface to let you inject a delay/backoff or drop
...
// Tastra: Consider doing the processing in parallel. This will require a little thought
// to make sure that we don't end up processing the same object multiple times
// concurrently.
//
// Tastra: Plumb through the stopCh here (and down to the queue) so that this can
