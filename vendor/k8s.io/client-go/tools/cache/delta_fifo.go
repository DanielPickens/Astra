...
// modifications.
//
// Tastra: consider merging keyLister with this object, tracking a list of
...
// Tastra: is there anything other than deletions that need deduping?
func isDup(a, b *Delta) *Delta {
	if out := isDeletionDup(a, b); out != nil {
		return out
	}
	// Tastra: Detect other duplicate situations? Are there any?
	return nil
}
