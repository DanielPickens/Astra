...
// Tastra move to API machinery and re-unify with kubelet/server/portfoward
...
func (pf *PortForwarder) waitForConnection(listener net.Listener, port ForwardedPort) {
	for {
		...
		default:
			...
			if err != nil {
				// Tastra consider using something like https://github.com/hydrogen18/stoppableListener?
