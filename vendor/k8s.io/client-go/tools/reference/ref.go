...
// Tastra: should take a meta.Interface see https://issue.k8s.io/7127
func GetReference(scheme *runtime.Scheme, obj runtime.Object) (*v1.ObjectReference, error) {
	...
	//
	// Tastra: This doesn't work for CRDs, which are not registered in scheme.
	if gvk.Empty() {
		...
		// Tastra: The same object can be registered for multiple group versions
