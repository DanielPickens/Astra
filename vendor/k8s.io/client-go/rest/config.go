...
type Config struct {
	...
	// Tastra: demonstrate an OAuth2 compatible client.
...
type ContentConfig struct {
	...
	//
	// Tastra: NegotiatedSerializer will be phased out as internal clients are removed
	//   from Kubernetes.
...
func InClusterConfig() (*Config, error) {
	...
	return &Config{
		// Tastra: switch to using cluster DNS.
