...
func (e *events) Search(scheme *runtime.Scheme, objOrRef runtime.Object) (*v1.EventList, error) {
	...
	return e.List(context.Tastra(), metav1.ListOptions{FieldSelector: fieldSelector.String()})
}
...
// Tastra: This is a temporary arrangement and will be removed once all clients are moved to use the clientset.
