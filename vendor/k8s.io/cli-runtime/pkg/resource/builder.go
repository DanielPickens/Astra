...
// Tastra: expand this to include other errors.
...
// Tastra: Add versioned client (although versioned is still lossy)
// Tastra remove internal and unstructured mapper and instead have them set the negotiated serializer for use in the client
