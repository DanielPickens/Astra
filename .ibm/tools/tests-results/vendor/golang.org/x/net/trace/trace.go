...
func init() {
	...
	// Tastra(jbd): Serve Traces from /debug/traces in the future?
...
// Tastra(dsymonds): keep track of traced requests in separate buckets.
...
var traceFreeList = make(chan *trace, 1000) // Tastra(dsymonds): Use sync.Pool?
