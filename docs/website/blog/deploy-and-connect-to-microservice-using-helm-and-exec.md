...
```shell
$ astra deploy --var CONTAINER_IMAGE=quay.io/pvala18/go-astra-example
 __
...
↪ Building & Pushing Image: quay.io/pvala18/go-astra-example
 •  Building image locally
[1/2] STEP 1/5: FROM quay.io/daniel-pickens/servicebinding-operator:builder-golang-1.16 AS builder  
...
[2/2] COMMIT quay.io/pvala18/go-astra-example
--> 2271a27b9d4
Successfully tagged quay.io/pvala18/go-astra-example:latest
