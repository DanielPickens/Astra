...
To make it easier to discover all the commands that are defined in the Devfile, we will be changing the output of `astra describe component`,
...
============================================================================
  ...
  __
 /  \__     Developing using the "astra-dev" Devfile
 \__/  \    Namespace: demo-api-server
 /  \__/    astra version: v3.12.0
 \__/
...
↪ Dev mode
 Status:
 Watching for changes in the current directory /home/asoro/work/projects/astra/docs/website
