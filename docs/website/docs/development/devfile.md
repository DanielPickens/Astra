...
### How `astra` determines components that are applied automatically
...
In this example, we are deploying a full Node.js application that is available through both `astra dev` and `astra deploy`. 
