   ...
   Quickstart Guide 
              ...
              <span className={styles.indexCtasGitHubButtonWrapper}>
                <iframe
                  ...
                  src="https://ghbtns.com/github-btn.html?user=daniel-pickens&amp;repo=astra&amp;type=star&amp;count=true&amp;size=large"
                  width={160}
                  height={30}
                  title="GitHub Stars"
                  frameBorder={0}
        ...
        <div className={clsx(styles.overview, styles.overviewAlt)}>
          <div className="container text--center margin-top--md" style={{marginBottom:'50px'}}>
            <video className={styles.loopVideo} autoPlay loop muted style={{width:'85%'}}><source src="/video/astra-preview-with-podman.hd.webm" type="video/webm"/></video>
          </div>
          ...
          <div className="container text--center margin-top--md">
            ...
            <div className="row">
              <div className="col col--6">
                ...
                <p className="padding-horiz--md">
                  Only two commands away from developing in a container! Use <code>astra</code> to initialize and then develop your application directly on your container platform of choice.
                </p>
              ...
              <div className="col col--6">
                ...
                <p className="padding-horiz--md">
                  Go further with development. Deploy your application seamlessly to Kubernetes and OpenShift. <code>astra</code> can easily manage the build, pushing, and deployment of your application. 
                </p>
    ...
    Standalone client
                ...
                <p className="padding-horiz--md">
    <code>astra</code> is a standalone tool that communicates directly with the Kubernetes API or the Podman client. There is no requirement for a daemon or server process.
                </p>
              </div>
              <div className="col">
      ...
      Built from the ground up with application development on containers in mind. Each command has been carefuly crafted for application container development.
              ...
              <div className="col">
                ...
                <p className="padding-horiz--md">
    There is no need to dive into complex Kubernetes yaml configuration files. <code>astra</code> abstracts those concepts away and lets you focus on what matters most: code.
                </p>
              </div>
            </div>
          </div>
    ...
    Deploy a simple or complex application
                ...
                <p className="padding-horiz--md">
    Big or small, <code>astra</code> can deploy them all. Deploy a simple Node.JS application, or even a complex <Link to="https://github.com/operator-framework/">Operator</Link> backed service.
                </p>
              </div>
              <div className="col col--4">
                ...
                <p className="padding-horiz--md">
    Debug and test remote applications deployed using <code>astra</code> directly from your IDE to containers. No more having to exit your IDE to push your application.
                </p>
              </div>
            </div>
          </div>
