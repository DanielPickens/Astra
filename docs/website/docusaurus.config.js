...
module.exports = {
  title: 'astra',
  tagline: 'astra - Fast iterative container-based application development',
  url: 'https://astra.dev',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  projectName: 'astra', // Usually your repo name.
  plugins: [
    [
      path.resolve(__dirname, 'docusaurus-astra-plugin-segment'),
      {
  ...
  themeConfig: {
    ...
    announcementBar: {
      ...
      content: `⭐️ Love astra? Support us by giving it a star on <a target="_blank" rel="noopener noreferrer" href="https://github\.com/danielpickens/astra">GitHub</a>! ⭐️`,
    },
    navbar: {
      title: 'astra',
      logo: {
      ...
      items: [
        ...
        {
          href: 'https://github\.com/danielpickens/astra',
          label: 'GitHub',
          position: 'right',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: '#astra on the Kubernetes Slack',
      ...
      copyright: `Copyright © ${new Date().getFullYear()} astra Authors -- All Rights Reserved <br> Apache License 2.0 open source project`,
    },
    prism: {
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github\.com/danielpickens/astra/edit/main/docs/website/',
        },
        blog: {
