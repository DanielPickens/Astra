...
// ExtractK8sAndOcComponentsFromOutputOnPodman extracts the list of Kubernetes and OpenShift components from the "astra" output on Podman.
...
// this function is usually used in combination with PODMAN_CMD_INIT_TIMEOUT astra preference
